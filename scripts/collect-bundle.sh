...
BUNDLE_NAME="boundary-layer-bundle-v1.0.3-${TIMESTAMP}"
...
BoundaryLayer v1.0.3 public provenance cleanup. Removed local tooling artifacts from public history. Nine security labs unchanged.
