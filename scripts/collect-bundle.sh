...
BUNDLE_NAME="boundary-layer-bundle-v1.0.6-${TIMESTAMP}"
...
BoundaryLayer v1.0.6 version consistency hotfix. Aligned API health version with release. Nine security labs unchanged.
