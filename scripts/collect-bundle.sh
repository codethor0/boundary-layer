...
BUNDLE_NAME="boundary-layer-bundle-v1.0.4-${TIMESTAMP}"
...
BoundaryLayer v1.0.4 public launch polish. Documentation and README updates only. Nine security labs unchanged.
