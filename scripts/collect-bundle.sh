...
BUNDLE_NAME="boundary-layer-bundle-v1.0.5-${TIMESTAMP}"
...
BoundaryLayer v1.0.5 visual identity and E2E validation polish. Documentation and logo assets only. Nine security labs unchanged.
