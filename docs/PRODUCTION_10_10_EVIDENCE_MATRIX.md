...
| 32 | Operational evidence | 2/10 | Completed evidence runner artifact | Structural gates only; Phase 8 blocked (no AWS/GitHub/IaC) | `artifacts/live-evidence/LIVE_STAGING_EVIDENCE.md` when live passes | Partial | Yes | No | `docs/PHASE_8_OPERATOR_RUNBOOK.md` | Operations | P0 |
