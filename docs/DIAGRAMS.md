...
Mermaid diagrams for BoundaryLayer runtime topology, lab flows, trust boundaries, observability, and release validation. Diagrams reflect current v1.3.2 behavior unless noted otherwise.
